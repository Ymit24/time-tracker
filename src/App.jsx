    ...
    <div className="h-screen flex flex-col bg-[var(--color-surface-0)] transition-colors duration-300 overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, var(--color-amber-accent), transparent 70%)",
          }}
        />
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, var(--color-teal-accent), transparent 70%)",
          }}
        />
      </div>
        ...
        <header className="flex items-center justify-between mb-3 shrink-0">
          <div className="flex items-center gap-3 sm:gap-4">
            <div className="flex items-center gap-2">
              <div
                className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-gradient-to-br from-[var(--color-amber-accent)] to-[var(--color-amber-accent)]/70
